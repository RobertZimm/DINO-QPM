...
from CleanCodeRelease.posttraining.visualisation.model_related.paired_gradcam_features import (
    _load_model,
    _get_display_image,
    _produce_combined_heatmap_image,
    _produce_gradcam_image,
)
from CleanCodeRelease.posttraining.visualisation.model_related.visualize_per_class import (
    get_class_names,
    get_class_features,
)
from CleanCodeRelease.posttraining.visualisation.model_related.backbone.single_image_viz import (
        ...
        for ds_idx in ds_indices:
            ...
            if gt_mask is not None and n_feat > 0:
                ...
                if "dilate" in overlap_calc_type or "dilated" in overlap_calc_type:
                    from CleanCodeRelease.helpers.img_tensor_arrays import (
                        dilate_mask,
                    )
...
def run_auto_discovery(
    ...
    *,
    ...
    from posttraining.visualisation.model_related.compare_classes import (
        run_cls_comparison,
    )
