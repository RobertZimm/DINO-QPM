...
import yaml
from CleanCodeRelease.ext_models import sinder
from CleanCodeRelease.ext_models.dinov2.models.vision_transformer import vit_large, vit_giant2, vit_small, vit_base
...
def load_sldd_feature_selection_and_assignment(log_dir: str | Path, n_per_class: int = 5, select_features: int = 50):
    from CleanCodeRelease.sparsification.glmBasedSparsification import load_glm
    from CleanCodeRelease.sparsification.sldd import get_sparsified_weights_for_factor
...
def load_qsenn_feature_selection_and_assignment(log_dir: str | Path, n_features: int = 50, n_per_class: int = 5):
    from CleanCodeRelease.sparsification.glmBasedSparsification import load_glm
    from CleanCodeRelease.sparsification.qsenn import get_sparsified_weights_for_factor
