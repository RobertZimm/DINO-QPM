...
<table width="100%">
  <tr valign="middle">
    ...
    <td width="50%">
      ...
      <p>We then apply an MLP to extract domain-specific representations, which are subsequently average-pooled to form the feature vector. Following this, our BLDD layer performs a binary low-dimensional transformation: it selects a global pool of 50 features and allocates exactly 5 of these to each class.</p>
