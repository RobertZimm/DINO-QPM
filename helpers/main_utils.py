...
from CleanCodeRelease.training.optim import get_scheduler_for_model
from CleanCodeRelease.helpers.file_system import get_folder_count, find_file_in_hierarchy
from CleanCodeRelease.configs.architecture_params import dino_supported_datasets
from CleanCodeRelease.slurmscripts.python.slurmFunctions import get_slurm_key
from CleanCodeRelease.configs.dataset_params import dataset_constants
from CleanCodeRelease.saving.logging import Tee
from CleanCodeRelease.helpers.optimize import optimize_finetune, optimize_dense
...
from CleanCodeRelease.configs.config_validation import validate_config
from CleanCodeRelease.configs.runtime_paths import get_tmp_root
...
def handle_seed(log_dir: Path,
    ...
    if seed is None:
        ...
        if os.path.exists(log_dir / "params.txt"):
            ...
            from CleanCodeRelease.configs.conf_getter import get_seeds
            seed = get_seeds()[0]
            print(
