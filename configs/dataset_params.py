...
from CleanCodeRelease.configs.optim_params import EvaluatedDict
...
normalize_params = {
    ...
    "ImageNet": {'mean': torch.tensor([0.485, 0.456, 0.406]),
    ...
    "Fitzpatrick17k": {'mean': torch.tensor([0.485, 0.456, 0.406]),
                       'std': torch.tensor([0.229, 0.224, 0.225])},  # Normalization from original paper
}
