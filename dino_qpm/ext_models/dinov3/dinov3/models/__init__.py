...
def build_model_for_eval(
    ...
    if pretrained_weights is None or pretrained_weights == "":
        ...
        from dino_qpm.ext_models.dinov3.dinov3.checkpointer import load_checkpoint
        ...
        from dino_qpm.ext_models.dinov3.dinov3.checkpointer import init_model_from_checkpoint_for_evals
