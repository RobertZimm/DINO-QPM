...
from dino_qpm.ext_models.dinov3.dinov3.utils import utils
...
def ac_compile_parallelize(
    ...
    from dino_qpm.ext_models.dinov3.dinov3.models.convnext import ConvNeXt
    from dino_qpm.ext_models.dinov3.dinov3.models.vision_transformer import DinoVisionTransformer
