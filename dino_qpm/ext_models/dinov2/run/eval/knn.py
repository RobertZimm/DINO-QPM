...
from dino_qpm.ext_models.dinov2.eval.knn import get_args_parser as get_knn_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from dino_qpm.ext_models.dinov2.eval.knn import main as knn_main
