...
class FGVCAircraftClass(VisionDataset):
    ...
    Aircraft model are organized in a three-levels hierarchy. The three levels, from
    finer to coarser, are:

    - ``variant``, e.g. Boeing 737-700. A variant collapses all the model that are visually
